...
import br.com.debra.nfe.schema.consCad.TUfCons;
...
import br.com.debra.nfe.wsdl.CadConsultaCadastro.CadConsultaCadastro4Stub;
    ...
    static TRetConsCad consultaCadastro(ConfiguracoesNfe config, PessoaEnum tipoPessoa, String cnpjCpf, EstadosEnum estado)
        ...
        try {
            ...
            if(EstadosEnum.MT.equals(estado)){
                br.com.debra.nfe.wsdl.CadConsultaCadastroMT.CadConsultaCadastro4Stub.ConsultaCadastro consultaCadastro = new br.com.debra.nfe.wsdl.CadConsultaCadastroMT.CadConsultaCadastro4Stub.ConsultaCadastro();
                br.com.debra.nfe.wsdl.CadConsultaCadastroMT.CadConsultaCadastro4Stub.NfeDadosMsg_type0 dadosMsg = new br.com.debra.nfe.wsdl.CadConsultaCadastroMT.CadConsultaCadastro4Stub.NfeDadosMsg_type0();
                dadosMsg.setExtraElement(ome);
                consultaCadastro.setNfeDadosMsg(dadosMsg);

                br.com.debra.nfe.wsdl.CadConsultaCadastroMT.CadConsultaCadastro4Stub stub = new br.com.debra.nfe.wsdl.CadConsultaCadastroMT.CadConsultaCadastro4Stub(
                ...
                br.com.debra.nfe.wsdl.CadConsultaCadastroMT.CadConsultaCadastro4Stub.NfeResultMsg result = stub.consultaCadastro(consultaCadastro);
