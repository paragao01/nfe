...
import br.com.debra.nfe.dom.Proxy;
...
public class ConfiguracoesNfe {
    ...
    public static ConfiguracoesNfe criarConfiguracoes(EstadosEnum estado, AmbienteEnum ambiente, Certificado certificado, String pastaSchemas)
        ...
        /*if (Logger.getLogger("").isLoggable(Level.SEVERE)) {
            System.err.println();
            System.err.println("####################################################################################");
            System.err.println(" Api Java Nfe - Versão 4.00.00 (C)");
            if (Logger.getLogger("").isLoggable(Level.WARNING)) {
                System.err.println(" Paulo Aragao - paragao01@gmail.com\n");
            }
